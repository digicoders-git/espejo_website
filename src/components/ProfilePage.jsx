                    ...
                    <div className="my-6 relative">
                      {order.status?.toLowerCase() === 'cancelled' ? (
                        <div className="flex flex-col items-center py-2">
                          <div className="w-full h-1 bg-red-100 dark:bg-red-900/20 rounded-full mb-3">
                            <div className="h-full bg-red-500 w-full rounded-full"></div>
                          </div>
                          <span className="text-red-500 font-bold text-[10px] uppercase tracking-widest flex items-center gap-1">
                            <span className="w-3 h-3 rounded-full border border-red-500 flex items-center justify-center text-[8px]">✕</span>
                            Order Cancelled
                          </span>
                        </div>
                      ) : (
